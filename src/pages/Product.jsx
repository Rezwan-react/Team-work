       ...
       {/* product Data */}
        <div className=' flex gap-12 sm:gap-12 flex-col sm:flex-row'>
          ...
          <div className=' flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
            ...
            <div className=' w-full sm:w-[80%]'>
             <img className=' w-full h-auto' src={image} alt="photo" />
            </div>
          </div>
          {/* ============product info==================== */}
          <div className=' flex-1'>
           ...
           <div className=' flex items-center gap-1 mt-2'>
            ...
            <img src={assets.star_icon} alt="star" className="w-3 5" />
            <img src={assets.star_icon} alt="star" className="w-3 5" />
            <img src={assets.star_dull_icon} alt="dul_star" className="w-3 5" />
        ...
        <div className=' mt-20'>
            ...
            <div className=' flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
             <p>An e-commerce website is online platfrom that facilitates the buying and selling of producs or servides over the internet. It serves as a virtual marketplace where business and individuals can showcase their products.</p>
